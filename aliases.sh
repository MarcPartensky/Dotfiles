...
alias vps="ssh vps"
alias tel="ssh tellocal || ssh tel"
...
alias robo3t="docker run --network host -e DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix njordr/robo3t"
alias krakenrestore="mongorestore -v --host localhost --port 27017 --gzip --archive=krakendump.bzip"
alias kraken="git -C $PROGRAMS_PATH/tia21 pull && docker-compose -f $PROGRAMS_PATH/tia21/docker-compose.yml up -d mongo lapin && dotnet run --project $PROGRAMS_PATH/tia21/src/Pssa.Tia21.Web && sleep 2 && xdg-open https://localhost:5000"
