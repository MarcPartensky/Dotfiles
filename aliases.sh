...
alias dslogs="docker service logs --raw -f"
...
alias minbrightness="brightnessctl s 1%"
alias maxrightness="brightnessctl s 100%"
alias lowbright="brightnessctl s 20%"
alias highbright="brightnessctl s 80%"
