...
alias robo3t="docker run --network host -e DISPLAY -v $HOME/.config/3T:/root/.config/3T -v $HOME/.3T:/root/.3T -v $HOME/.ssh/id_rsa:/root/.ssh/id_rsa -v $HOME/.ssh/config:/root/.ssh/config -v /tmp/.X11-unix:/tmp/.X11-unix marcpartensky/robo3t"
