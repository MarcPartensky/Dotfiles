...
alias caddystop="ssh caddix service Caddy stop"
alias caddystart="ssh caddix service Caddy start"
alias caddyrestart="ssh caddix service Caddy restart"
alias caddylogs="ssh caddix journalctl --since today -f -xu Caddy"
