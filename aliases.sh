...
alias alacrittyrc="nvim $DOTFILES_PATH/alacritty/.config/alacritty/alacritty.yml"
alias yabairc="nvim $DOTFILES_PATH/yabai/.config/yabai/.yabairc"
alias skhdrc="nvim $DOTFILES_PATH/skhdrc/.config/skhd/skhdrc"
