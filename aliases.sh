...
alias kraken="git -C $PROGRAMS_PATH/tia21 pull && docker-compose -f $PROGRAMS_PATH/tia21/docker-compose.yml up -d mongo lapin && dotnet run --project $PROGRAMS_PATH/tia21/src/Pssa.Tia21.Web"
